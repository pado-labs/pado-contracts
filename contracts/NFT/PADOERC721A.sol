...
contract PADOERC721A is Initializable, ERC721AUpgradeable, OwnableUpgradeable, IERC2981Upgradeable
{
    ...
    function initialize(string memory name_,
        ...
        string memory placeholderImage_) public initializer initializerERC721A {
